          ...
          <div style={{ marginBottom: 20 }}>
            ...
            {showTierEditor && (
              <div style={{ ...card, marginTop: 12 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "60px 60px 1fr 1fr 1fr 32px", gap: 8, marginBottom: 8 }}>
                ...
                {tiers.map((t, idx) => (
                  <div key={idx} style={{ display: "grid", gridTemplateColumns: "60px 60px 1fr 1fr 1fr 32px", gap: 8, marginBottom: 8 }}>
